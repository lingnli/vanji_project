		...
		<div class="ProductTab" style="display:none">
			<div class="ProductsDetail">
				<div class="entry-main">
					...
					<div class="post-featured animated fadeInRight">
						<img src="<?=base_url()?>assets/Front/images/1.jpg" alt="">
					</div>

					<div class="entry-footer">
						<div class="social-share"><!-- Content social share -->
							<a href="#" style="width:80px"><img src="<?=base_url()?>assets/Icon/facebook.png" style="width:80px"></a>
							<a href="#" style="width:80px"><img src="<?=base_url()?>assets/Icon/line.png" style="width:80px"></a>
						</div>
					</div>
			...
			<div class="ProductsDetail">
				<div class="entry-main">
					...
					<!-- Post thumbnail -->
					<div class="post-featured animated fadeInRight">
						<img src="<?=base_url()?>assets/Front/images/2.jpg" alt="">
					</div>
			...
			<div class="ProductsDetail">
				<div class="entry-main">
					...
					<!-- Post thumbnail -->
					<div class="post-featured animated fadeInRight">
						<img src="<?=base_url()?>assets/Front/images/3.jpg" alt="">
					</div>
			...
			<div class="ProductsDetail">
				<div class="entry-main">
					...
					<!-- Post thumbnail -->
					<div class="post-featured animated fadeInRight">
						<img src="<?=base_url()?>assets/Front/images/4.jpg" alt="">
					</div>
			...
			<div class="ProductsDetail">
				<div class="entry-main">
					...
					<!-- Post thumbnail -->
					<div class="post-featured animated fadeInRight">
						<img src="<?=base_url()?>assets/Front/images/5.jpg" alt="">
					</div>
