                        ...
                        <form class="form-horizontal" role="form" method="POST" action="<?= $action ?>" id="new_form" enctype='multipart/form-data'>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <? elseif($item[2] == "day"): ?>
                                    <input type="text" class="form-control daypicker" name="<?= $item[1] ?>" value="<?= ($item[3])?$item[3]:date("Y-m-d") ?>" autocomplete="off" <?= (isset($can_edit) && !$can_edit) ? " disabled" : "" ?>>
                                    ...
                                    <? endif; ?>
                                    <input type="hidden" name="<?= $item[1] ?>" id="<?= $item[1] ?>" value="<?= $item[3] ?>">
                                    <div id="img_<?= $item[1] ?>" style="width: 256px; margin-top: 6px; background-color: #FFF; border:1px solid #706A6B; padding: 2px; border-radius: 2px;<?= ($item[3] == "") ? ' display:none;' : "" ?>">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.datetimepicker').datepicker({
            ...
            todayBtn: true,
            todayHighlight: true,
            autoclose: true        //也可以通過function函式獲得值
        });
