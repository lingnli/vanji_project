        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1">
                <div class="lockscreen-container">
                    <div id="output"></div>
                    <h1 style="color:white">梵日珠寶管理系統</h1>
                    <div class="form-box">
                        <!-- <div class="avatar" style="background: url(<?= base_url() ?>assets/images/wish_logo.svg); background-color: #FFF; background-size: contain;"></div> -->
