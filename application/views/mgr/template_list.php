...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <? foreach ($tool_btns as $item) : ?>
            <? if ($item[0] == 'timezone_select') : ?>
                <h5 class="pull-right" style="margin-top: -20px; margin-right: 40px; display: inline-flex; line-height: 34px;">
                    <div>
                        Current Time: <strong class="current_time" style="font-size: 16px;"></strong>
                    </div>
                    <select class="select2">
                        <? foreach ($timezone as $t) : ?>
                            <option><?= $t['country_name'] ?></option>
                        <? endforeach; ?>
                    </select>
                    <!-- <div class="dropdown user-menu" style="margin-left: 10px;">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <span><?= $timezone['TW']['country_name'] ?> <i class="caret"></i></span>
                        </a>
                        <ul class="dropdown-menu">
                            <? foreach ($timezone as $t) : ?>
                            <li><a href="javascript:void(0)"><?= $t['country_name'] ?></a></li>
                            <? endforeach; ?>
                        </ul>
...
<!-- template add Modal -->
<div class="modal fade" id="reviewRejectModal" role="dialog" aria-labelledby="modalLabel" tabindex="-1">
    <div class="modal-dialog" role="document" style="width: 800px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">審核不通過
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </h5>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <button id="template_save" type="button" class="btn btn-primary" data-dismiss="modal">確認</button>
            </div>
        </div>
    </div>
</div>
