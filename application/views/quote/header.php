...
<head>
  ...
  <title>梵日珠寶 - Vanji Jewelry</title>
  ...
  <!-- Icon Font CSS -->
  <link rel="stylesheet" href="<?= base_url() ?>assets/css/vendor/ionicons.min.css">
  ...
  <script>
    ...
    fbq('init', '526350301548202');
    fbq('track', 'PageView');
  </script>
  <noscript>
    <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=526350301548202&ev=PageView&noscript=1" />
  </noscript>
